...
@section('title')
<title>Zetalabs :: Expertos en Tecnologia</title>
@stop
...
<footer id="footer">
    <div class="container">
      <div class="row">
        ...
        <div class="span8 footer-links"> <a href="#home" title="Home" class="scroll-page">HOME</a> | <a href="#nosotros" title="Nosotros" class="scroll-page">NOSOTROS</a> | <a href="#servicios" title="Servicios" class="scroll-page">SERVICIOS</a> | <a href="#portafolio" title="Portafolio" class="scroll-page">PORTAFOLIO</a> | <a href="#contacto" title="Contact" class="scroll-page">CONTACTO</a> | <a href="http://blog.zetalabs.cl" target="_blank" title="Blog">BLOG</a> </div>
      </div>
    </div>
  </footer>
